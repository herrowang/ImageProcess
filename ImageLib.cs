...
namespace RoomCV
{
    ...
    public class TROI
    {
        ...
        //public void SetGravity(TPoint gpoint)
        //{
            //gravity.X = gpoint.X;
            //gravity.Y = gpoint.Y;
            //gravity.nLabel = gpoint.nLabel;
            //gravity.type = gpoint.type;
        //    gravity = gpoint;
        //}
        //public TPoint GetGrayPoint()
        //{
        //    return gravity;
        //}
        ...
        public void DrawLine(TROI roi, Graphics g)
        {
            SolidBrush brush = new SolidBrush(Color.Aqua);
            ...
            foreach (Point p in roi.paths)
            {
                ...
                g.FillRectangle(Brushes.Pink, rp);
            }
